...
var PrismaDefinitionClass = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, yaml_1.readDefinition(this.definitionPath, args, this.out, this.envVars)];
                    case 1:
    ...
    Object.defineProperty(PrismaDefinitionClass.prototype, "clusterBaseUrl", {
        get: function () {
            ...
            var clusterBaseUrl = parseEndpoint(this.definition.endpoint).clusterBaseUrl;
    ...
    Object.defineProperty(PrismaDefinitionClass.prototype, "service", {
        get: function () {
            ...
            var service = parseEndpoint(this.definition.endpoint).service;
            return service;
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(PrismaDefinitionClass.prototype, "stage", {
        get: function () {
            ...
            var stage = parseEndpoint(this.definition.endpoint).stage;
            return stage;
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(PrismaDefinitionClass.prototype, "cluster", {
        get: function () {
            ...
            var clusterName = parseEndpoint(this.definition.endpoint).clusterName;
            return clusterName;
        },
        enumerable: true,
        configurable: true
    ...
    PrismaDefinitionClass.prototype.getCluster = function (throws) {
        ...
        if (this.definition && this.definition.endpoint) {
            var _a = parseEndpoint(this.definition.endpoint), clusterBaseUrl = _a.clusterBaseUrl, isPrivate = _a.isPrivate, local = _a.local, shared = _a.shared, workspaceSlug = _a.workspaceSlug, clusterName_1 = _a.clusterName;
            if (clusterBaseUrl) {
                var cluster = new Cluster_1.Cluster(this.out, clusterName_1, clusterBaseUrl, shared
                    ? this.env.cloudSessionKey
                    : process.env.PRISMA_MANAGEMENT_SECRET, local, shared, isPrivate, workspaceSlug);
    ...
    PrismaDefinitionClass.prototype.getWorkspace = function () {
        ...
        if (this.definition && this.definition.endpoint) {
            var workspaceSlug = parseEndpoint(this.definition.endpoint).workspaceSlug;
            if (workspaceSlug) {
...
function parseEndpoint(endpoint) {
    ...
    var shared = url.origin.includes('eu1.prisma') || url.origin.includes('us1.prisma');
...
function getEndpoint(cluster, service, stage, workspace) {
    var url = cluster.baseUrl;
