...
function makeDefinition(yml, datamodel, args, globalRC, envVars) {
    ...
    var modelPath = path.join(definitionDir, 'datamodel.graphql');
...
describe('prisma definition', function () {
    ...
    test('load yml with secret and env var', function () { return __awaiter(_this, void 0, void 0, function () {
        var secret, yml, datamodel, definition;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test('load yml with secret and env var in .env', function () { return __awaiter(_this, void 0, void 0, function () {
        var secret, yml, datamodel, _a, definition, env, envPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    secret = 'this-is-a-long-secret';
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, definition.load({}, envPath)];
                case 2:
                    _b.sent();
                    expect(definition.definition).toMatchSnapshot();
    ...
    test('load yml with injected env var', function () { return __awaiter(_this, void 0, void 0, function () {
        var secret, yml, datamodel, envVars, _a, definition, env;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    secret = 'this-is-a-long-secret';
    ...
    test('dont load yml with secret and env var in args', function () { return __awaiter(_this, void 0, void 0, function () {
        var yml, datamodel, definitionDir, definitionPath, modelPath, env, definition, error, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    yml = "service: jj\nstage: dev\ncluster: local\n\ndatamodel:\n- datamodel.graphql\n\nschema: schemas/database.graphql\n    ";
    ...
    test('throw when no secret or disable auth provided', function () { return __awaiter(_this, void 0, void 0, function () {
        var yml, datamodel, error, definition, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    yml = "service: jj\nstage: dev\ncluster: local\n\ndatamodel:\n- datamodel.graphql\n\nschema: schemas/database.graphql\n    ";
    ...
    test('throws when stages key apparent', function () { return __awaiter(_this, void 0, void 0, function () {
        var yml, datamodel, error, definition, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    yml = "service: jj\nstage: dev\ncluster: local\n\ndatamodel:\n- datamodel.graphql\n\nschema: schemas/database.graphql\n\nstages:\n  dev: local\n    ";
...
describe('parseEndpoint', function () {
    test('work for minimal url', function () {
        expect(PrismaDefinition_1.parseEndpoint('http://localhost:4466')).toMatchSnapshot();
    });
    test('work for url with service', function () {
        expect(PrismaDefinition_1.parseEndpoint('http://localhost:4466/service-name')).toMatchSnapshot();
    });
    test('work for url with service and stage', function () {
        expect(PrismaDefinition_1.parseEndpoint('http://localhost:4466/service-name/stage')).toMatchSnapshot();
    });
});
