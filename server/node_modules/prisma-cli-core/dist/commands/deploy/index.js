...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.getCluster = function (serviceName, stage) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, workspaceClusterCombination, splitted, workspace, clusterName, exists, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                    ...
                    case 1:
                        _a.loggedIn = _c.sent();
                        return [4 /*yield*/, this.clusterSelection(serviceName, stage, this.loggedIn)];
                    case 2:
                        workspaceClusterCombination = _c.sent();
                    ...
                    case 7:
                        _b = !exists.isPrivate && !exists.shared;
