...
var Playground = /** @class */ (function (_super) {
    ...
    Playground.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var web, envFile, serviceName, stage, clusterName, cluster, graphqlBin, args, localPlaygroundPath, endpoint, envPath, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, spawn_1.spawn(graphqlBin, args)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
