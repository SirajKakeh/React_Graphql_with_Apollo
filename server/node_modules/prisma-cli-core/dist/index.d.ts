...
export declare const commands: (typeof Init | typeof Playground)[];
export { Deploy, Init, Info, Playground, List, Delete, UpgradeLocal, Stop, Up, Eject, Logs, PsLocal, Reset, Account, Import, Export, Token, Login, ClusterToken, ClusterList, ClusterLogs, ClusterAdd, ClusterRemove, InitPrisma };
