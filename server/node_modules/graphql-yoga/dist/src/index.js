...
var GraphQLServer = /** @class */ (function () {
    function GraphQLServer(props) {
        ...
        if (props.schema) {
            ...
            var directiveResolvers = props.directiveResolvers, resolvers = props.resolvers, typeDefs = props.typeDefs;
    ...
    GraphQLServer.prototype.start = function (optionsOrCallback, callback) {
        ...
        return new Promise(function (resolve, reject) {
            if (!subscriptionServerOptions) {
                var server_1 = http_1.createServer(app);
                server_1.listen(_this.options.port, function () {
